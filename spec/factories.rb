    ...
    factory :congress_member_with_actions_parent do
      ...
      factory :congress_member_with_actions_and_captcha do
        after(:create) do |c|
          ...
          create :congress_member_action, action: "fill_in", captcha_selector: "#captcha-image", captcha_id_selector: "#captcha", value: "$CAPTCHA_SOLUTION", step: 14, congress_member: c
